...
# Command Used: write_xdc -no_fixed_only -force ./outputs/logic_ex_post.xdc
####################################################################################
...
set_property BEL B5LUT [get_cells {LED_OBUF[0]_inst_i_1}]
set_property BEL OUTBUF [get_cells {LED_OBUF[1]_inst}]
set_property BEL A5LUT [get_cells {LED_OBUF[1]_inst_i_1}]
set_property BEL OUTBUF [get_cells {LED_OBUF[2]_inst}]
set_property BEL A6LUT [get_cells {LED_OBUF[2]_inst_i_1}]
set_property BEL OUTBUF [get_cells {LED_OBUF[3]_inst}]
set_property BEL B6LUT [get_cells {LED_OBUF[3]_inst_i_1}]
set_property BEL INBUF_EN [get_cells {SW_IBUF[0]_inst}]
set_property BEL INBUF_EN [get_cells {SW_IBUF[1]_inst}]
set_property LOC SLICE_X0Y101 [get_cells {LED_OBUF[0]_inst_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {LED_OBUF[1]_inst_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {LED_OBUF[2]_inst_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {LED_OBUF[3]_inst_i_1}]
